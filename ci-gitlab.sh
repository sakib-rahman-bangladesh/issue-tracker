...
git commit -m "Updated contents same as GitLab"
...
git remote set-url origin git@gitlab.com:sakib-rahman-bangladesh/issue-tracker.git
...
git push --all -f git@gitlab.com:sakib-rahman-bangladesh/issue-tracker.git