...
git commit -m "obstacle 1: FORESTHUNTER"
...
git remote set-url origin https://github.com/sakib-rahman-bangladesh/cocos2d-games
...
git push --all -f https://github.com/sakib-rahman-bangladesh/cocos2d-games