...
git remote set-url origin https://github.com/sakib-rahman-bangladesh/issue-tracker
...
git push --all -f https://github.com/sakib-rahman-bangladesh/issue-tracker